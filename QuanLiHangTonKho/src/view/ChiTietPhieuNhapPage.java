 ...
 * @author ASUS
 */
public class ChiTietPhieuNhapPage extends javax.swing.JInternalFrame {

    final String header[] = {"Mã chi tiết phiếu nhập ", "Mã phiếu nhập", "Mã sản phẩm", "Số lượng", "Tổng tiền"};
    ...
    public ChiTietPhieuNhapPage() {
        initComponents();
        this.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        BasicInternalFrameUI ui = (BasicInternalFrameUI) this.getUI();
        ui.setNorthPane(null);
        loadChiTietPhieuNhap();
        txtMaCTPN.setVisible(false);
    }
    ...
    public void loadChiTietPhieuNhap() {
        try {
            ...
            int number;
            Vector row;
            String sql = "SELECT MaCTPN,MaPhieuNhap,MaSanPham,SoLuong,TongTien FROM dbo.ChiTietPhieuNhap";
            ...
            while (rs.next()) {
                ...
                for (int i = 1; i <= number; i++) {
                    row.add(rs.getString("MaCTPN").trim());
                ...
                tb.addRow(row);
                tableChiTietPhieuNhap.setModel(tb);
            }
            st.close();
            rs.close();
        } catch (Exception e) {
        }
        tableChiTietPhieuNhap.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent e) {
                if (tableChiTietPhieuNhap.getSelectedRow() >= 0) {
                    txtMaCTPN.setText(tableChiTietPhieuNhap.getValueAt(tableChiTietPhieuNhap.getSelectedRow(), 0) + "");
                    txtMaPhieuNhap.setText(tableChiTietPhieuNhap.getValueAt(tableChiTietPhieuNhap.getSelectedRow(), 1) + "");
                    txtMaSanPham.setText(tableChiTietPhieuNhap.getValueAt(tableChiTietPhieuNhap.getSelectedRow(), 2) + "");
                    txtSoLuong.setText(tableChiTietPhieuNhap.getValueAt(tableChiTietPhieuNhap.getSelectedRow(), 3) + "");
                    txtTongTien.setText(tableChiTietPhieuNhap.getValueAt(tableChiTietPhieuNhap.getSelectedRow(), 4) + "");
                }
            }
    ...
    private void initComponents() {
        ...
        tableChiTietPhieuNhap.setPreferredSize(new java.awt.Dimension(350, 80));
        jScrollPane1.setViewportView(tableChiTietPhieuNhap);

        jPanel2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.setPreferredSize(new java.awt.Dimension(450, 281));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtMaCTPN, javax.swing.GroupLayout.PREFERRED_SIZE, 335, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtTongTien, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addComponent(txtMaCTPN, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void buttonCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCapNhatActionPerformed
        ...
        try {
            if (txtMaPhieuNhap.getText().equals("") || txtMaSanPham.getText().equals("") || txtSoLuong.getText().equals("") || txtTongTien.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "Bạn cần nhập dữ liệu");
            } else {
                Statement st = conn.createStatement();
                String sqlUpdate = "UPDATE dbo.ChiTietPhieuNhap SET MaPhieuNhap='" + txtMaPhieuNhap.getText() + "', MaSanPham ='" + txtMaSanPham.getText() + "',SoLuong ='" + txtSoLuong.getText() + "',TongTien ='" + txtTongTien.getText() + "' WHERE MaCTPN = '" + txtMaCTPN.getText() + "'";
                try {
    ...
    private void buttonThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonThemActionPerformed
        ...
        try {
            if (txtMaPhieuNhap.getText().equals("") || txtMaSanPham.getText().equals("") || txtSoLuong.getText().equals("") || txtTongTien.getText().equals("")) {
                ...
                String sqlCheck = "SELECT MaCTPN FROM dbo.ChiTietPhieuNhap WHERE MaCTPN = '" + txtMaCTPN.getText() + "'";
                Statement st = conn.createStatement();
                ResultSet rs = st.executeQuery(sqlCheck);
                if (rs.next()) {
                    sb.append("Mã chi tiết phiêu nhập đã tồn tại!.Hãy làm mới và nhập lại");
                }
                if (sb.length() > 0) {
                    JOptionPane.showMessageDialog(this, sb.toString());
                } else {
                    String sqlInsert = "INSERT INTO dbo.ChiTietPhieuNhap (MaPhieuNhap,MaSanPham,SoLuong,TongTien) VALUES (?,?,?,?)";
                    try {
                        pst = conn.prepareStatement(sqlInsert);
                        pst.setString(1, txtMaPhieuNhap.getText());
    ...
    private void ButtonXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonXoaActionPerformed
        conn = cn.getConnection();
        try {
            String sqlDelete = "DELETE dbo.ChiTietPhieuNhap WHERE MaCTPN = '" + txtMaCTPN.getText() + "'";
            Statement st = conn.createStatement();
    ...
    private void txtTimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyReleased
        DefaultTableModel ob = (DefaultTableModel) tableChiTietPhieuNhap.getModel();
        TableRowSorter<DefaultTableModel> row = new TableRowSorter<>(ob);
        tableChiTietPhieuNhap.setRowSorter(row);
        row.setRowFilter(RowFilters.regexFilter(txtTimKiem.getText()));
